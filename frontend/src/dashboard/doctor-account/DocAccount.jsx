...
import DocAbout from '../../pages/DocAbout';
          ...
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
            ...
            <div className="lg:col-span-2">
              {data.isApproved==='pending' && (
                <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  >
                    <path 
                      fillRule="evenodd" 
                      d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h-90a1 1 0 100-2v-3a1 1 0 00-1-1H9z" 
                      clipRule="evenodd" >      
                    </path>
                  </svg>
                  <span className="sr-only">Info</span>
                  <div className="ml-3 text-sm font-medium">
                    To get approval please complete your profile. We'll review manually and approve withing 3 days.
                  </div>
                </div>
              )}
              ...
              <div className="mt-8">
                  ...
                  <div>
                    ...
                    <div>
                      <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] lg:text-[16px] font-semibold">
                        {data?.specialisation || 'Your specialisation'}
                      </span>
                      ...
                      <p className="text_para font-[15px] lg:max-w-[390px]">
                        {data.bio}
                      </p>
                    </div>
                    </div>
                ...
                {tab === 'settings' && <div><ProfileSetting doctorData={data} /></div>}
              </div>
            </div>
          </div>
        )}
